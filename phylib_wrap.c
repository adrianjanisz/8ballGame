...
SWIGINTERN PyObject *_wrap_checkIfNotNULL(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  phylib_object *arg1 = (phylib_object *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1,SWIGTYPE_p_phylib_object, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "checkIfNotNULL" "', argument " "1"" of type '" "phylib_object *""'"); 
  }
  arg1 = (phylib_object *)(argp1);
  result = (int)checkIfNotNULL(arg1);
  resultobj = SWIG_From_int((int)(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "checkIfNotNULL", _wrap_checkIfNotNULL, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
